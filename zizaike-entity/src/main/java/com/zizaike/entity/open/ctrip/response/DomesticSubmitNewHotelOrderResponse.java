...
public class DomesticSubmitNewHotelOrderResponse extends ResponseData {
    ...
    public String toString() {
        return "DomesticSubmitNewHotelOrderResponse [message=" + message + ", resultCode=" + resultCode
                + ", domesticSubmitNewHotelOrder=" + domesticSubmitNewHotelOrder + "]";
    }
    ...
    public static void main(String[] args) {
        ...
        stream.processAnnotations(DomesticSubmitNewHotelOrderResponse.class);
        DomesticSubmitNewHotelOrderResponse obj = (DomesticSubmitNewHotelOrderResponse) stream.fromXML(xml);
