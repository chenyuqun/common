...
public class DomesticCheckRoomAvailResp extends ResponseData {
    ...
    public static void main(String[] args) {
        String xml = "<RequestResult>" + "<Message>string</Message>" + "<ResultCode>int</ResultCode>"
                + "<DomesticCheckRoomAvailResponse>" + "<!--是否能预订(1:可订;0:不可预订)-->" + "<IsBookable>1</IsBookable>"
                + "<!--房型编号,需要转换为携程的房型编号-->" + "<Room>4809658</Room>" + "<!--接口订单金额-->"
                + "<InterFaceAmount>-1.0000</InterFaceAmount>" + "<!--错误描述-->"
                + "<ReturnDescript>错误描述</ReturnDescript>" + "<RoomPrices>" + "<!--每个RoomPrice对应一天价格-->" + "<RoomPrice>"
                + "<EffectDate>2014-07-05T00:00:00</EffectDate>" + "<Price>618.0000</Price>" + "<CNYPrice>0</CNYPrice>"
                + "<Cost>0</Cost>" + "<CNYCost>0</CNYCost>" + "<BreakFast>0</BreakFast>" + "</RoomPrice>"
                + "<RoomPrice>" + "<EffectDate>2014-07-06T00:00:00</EffectDate>" + "<Price>618.0000</Price>"
                + "<CNYPrice>0</CNYPrice>" + "<Cost>0</Cost>" + "<CNYCost>0</CNYCost>" + "<BreakFast>0</BreakFast>"
                + "</RoomPrice>" + "</RoomPrices>" + "<!--可用房数量-->" + "<AvailRoomQuantitys>" + "<AvailRoomQuantity>"
                + "<EffectDate>2014-07-03T00:00:00</EffectDate>" + "<AvailQuantity>8</AvailQuantity>"
                + "</AvailRoomQuantity>" + "<AvailRoomQuantity>" + "<EffectDate>2014-07-04T00:00:00</EffectDate>"
                + "<AvailQuantity>8</AvailQuantity>" + "</AvailRoomQuantity>" + "</AvailRoomQuantitys>"
                + "</DomesticCheckRoomAvailResponse>" + "</RequestResult>";
        ...
        System.err.println(stream.toXML(obj));
        ...
        System.out.println(stream.toXML(test));

        /**
         * String xml = "<RoomPrices>" +"<!--每个RoomPrice对应一天价格-->" +"<RoomPrice>"
         * +"<EffectDate>2014-07-05T00:00:00</EffectDate>" +"<Price>618.0000</Price>" +"<CNYPrice>0</CNYPrice>"
         * +"<Cost>0</Cost>" +"<CNYCost>0</CNYCost>" +"<BreakFast>0</BreakFast>" +"</RoomPrice>" +"<RoomPrice>"
         * +"<EffectDate>2014-07-06T00:00:00</EffectDate>" +"<Price>618.0000</Price>" +"<CNYPrice>0</CNYPrice>"
         * +"<Cost>0</Cost>" +"<CNYCost>0</CNYCost>" +"<BreakFast>0</BreakFast>" +"</RoomPrice>" +"</RoomPrices>";
         * XStream stream = new XStream(); stream.processAnnotations(RoomPrices.class); RoomPrices obj = (RoomPrices)
         * stream.fromXML(xml); System.out.println(obj);
         **/

        /**
         * String xml = "<AvailRoomQuantitys>" +"<AvailRoomQuantity>" +"<EffectDate>2014-07-03T00:00:00</EffectDate>"
         * +"<AvailQuantity>8</AvailQuantity>" +"</AvailRoomQuantity>" +"</AvailRoomQuantitys>"; XStream stream = new
         * XStream(); stream.processAnnotations(AvailRoomQuantitys.class); AvailRoomQuantitys obj = (AvailRoomQuantitys)
         * stream.fromXML(xml); System.out.println(obj);
         **/
    }
}
