...
public class DomesticCheckRoomAvailRequest extends RequestData {
    ...
    private DomesticCheckRoomAvailReq domesticCheckRoomAvail;
    ...
    public DomesticCheckRoomAvailReq getDomesticCheckRoomAvail() {
        return domesticCheckRoomAvail;
    }
    public void setDomesticCheckRoomAvail(DomesticCheckRoomAvailReq domesticCheckRoomAvail) {
