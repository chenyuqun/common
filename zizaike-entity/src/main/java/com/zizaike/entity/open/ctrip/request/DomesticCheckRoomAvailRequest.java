...
public class DomesticCheckRoomAvailRequest extends RequestData{
    ...
    public DomesticCheckRoomAvailRequest(String hotel, Date arrival, Date departure, String room, String currencyCode,
            Integer roomNumber, Integer person, BalanceType balanceType, RoomPrices roomPrices) {
        super();
        this.hotel = hotel;
    ...
    public String toString() {
        return "DomesticCheckRoomAvailRequest [hotel=" + hotel + ", arrival=" + arrival + ", departure=" + departure
                + ", room=" + room + ", currencyCode=" + currencyCode + ", roomNumber=" + roomNumber + ", person="
                + person + ", balanceType=" + balanceType + ", roomPrices=" + roomPrices + "]";
    }
